...
$BuildDir = Join-Path $ToolsRoot 'test-build\ComponentMutation'
New-Item -ItemType Directory -Force -Path $BuildDir | Out-Null

$Source = Join-Path $TestDir 'ComponentMutationTests.cpp'
$Exe = Join-Path $BuildDir 'ComponentMutationTests.exe'
